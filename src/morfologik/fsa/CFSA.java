 ...
 * slightly reorganized version of {@link FSA5} offering smaller automata
 * size at some performance penalty.
 * 
 * <p>
...
public final class CFSA extends FSA {
    ...
    /**
     * Label mapping for arcs of type (1) (see class documentation). The array is indexed
     * by mapped label's value and contains the original label.
     */
