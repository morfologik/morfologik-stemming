	...
	public static int getFlags(int version) {
		...
		switch (version) {
			case 0:
				...
				break;
			case (byte) 0x80:
				flags = LARGE_DICTIONARIES.bits;
				break;
			case 1:
				flags = FLEXIBLE.bits;
				break;
			case 2:
				flags = FLEXIBLE.bits | NEXTBIT.bits;
				break;
			case 4:
				flags = FLEXIBLE.bits | STOPBIT.bits;
				break;
			case FSA.VERSION_CFSA:
			case FSA.VERSION_5:
				flags = FLEXIBLE.bits | STOPBIT.bits | NEXTBIT.bits;
				break;
			case 6:
				flags = FLEXIBLE.bits | STOPBIT.bits | TAILS.bits;
				break;
			case 7:
				flags = FLEXIBLE.bits | STOPBIT.bits | NEXTBIT.bits
				        | TAILS.bits;
			...
			default:
				throw new RuntimeException(
				        "Unknown version number. FSA created with unknown options.");
		}
